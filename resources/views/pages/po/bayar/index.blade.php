...
<link rel="stylesheet" type="text/css" href="{{ url('app/app-assets/css/pages/app-invoice.css')}}">
@endsection
@section('js')
<script src="{{ url('app/app-assets/vendors/js/forms/repeater/jquery.repeater.min.js')}}"></script>
<script src="{{ url('app/app-assets/vendors/js/pickers/flatpickr/flatpickr.min.js')}}"></script>
<script src="{{ url('app/app-assets/js/scripts/pages/app-invoice.js')}}"></script>
@endsection