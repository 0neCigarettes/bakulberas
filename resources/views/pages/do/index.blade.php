    ...
    <div class="row">
      <div class="col-md-12 col-12">
              ...
              <div class="row">
                <div class="col-md-2">
                  <div class="mb-1">
                    ...
                    <input type="text" autocomplete="off" id="kode" class="form-control" name="o[kode]" required="true" readonly="true" value="DO-{{$time}}"/>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="mb-1">
                    <label class="col-form-label" for="po">Pemesanan</label>
                    <v-select id="suplier" class="style-chooser" label="nama" placeholder="cari nama suplier" :reduce="s => s.id" :options="customers"></v-select>
                    <input type="text" hidden name="o[po_id]" />
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="mb-1">
		...
		<div class="row">
			<div class="col-12">
				<div class="card">
					<table class="datatables-custom-ro table table-bordered" data-label="LIST PENGIRIMAN (DO)">
						<thead>
							<tr>
								<th>Kode SO</th>
								<th>Nama Suplier</th>
